...
public class ARABIClanguageClass {
    public static Logger log = Logger.getLogger(ARABIClanguageClass.class);
    public static Map<String, Map<String, Integer>> ngrams = new HashMap<>();
    private int n;

    public ARABIClanguageClass(int n) {
        this.n = n;
    }
    ...
    public static String classifyARABIC(String text, double percentage) {
        ARABIClanguageClass detector = new ARABIClanguageClass(3);
        try {
    ...
    /*public static NgramModel arabicModel(){
